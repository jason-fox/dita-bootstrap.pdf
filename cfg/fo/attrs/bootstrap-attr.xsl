...
>
  ...
  <xsl:attribute-set name="px-0"><xsl:attribute name="padding-left">0</xsl:attribute><xsl:attribute
      name="padding-right"
    >0</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="px-1"><xsl:attribute name="padding-left">3pt</xsl:attribute><xsl:attribute
      name="padding-right"
    >3pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="px-2"><xsl:attribute name="padding-left">6pt</xsl:attribute><xsl:attribute
      name="padding-right"
    >6pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="px-3"><xsl:attribute name="padding-left">12pt</xsl:attribute><xsl:attribute
      name="padding-right"
    >12pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="px-4"><xsl:attribute name="padding-left">18pt</xsl:attribute><xsl:attribute
      name="padding-right"
    >18pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="px-5"><xsl:attribute name="padding-left">36pt</xsl:attribute><xsl:attribute
      name="padding-right"
    >36pt</xsl:attribute></xsl:attribute-set>

  <xsl:attribute-set name="py-0"><xsl:attribute name="padding-top">0</xsl:attribute><xsl:attribute
      name="padding-bottom"
    >0</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="py-1"><xsl:attribute name="padding-top">3pt</xsl:attribute><xsl:attribute
      name="padding-bottom"
    >3pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="py-2"><xsl:attribute name="padding-top">6pt</xsl:attribute><xsl:attribute
      name="padding-bottom"
    >6pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="py-3"><xsl:attribute name="padding-top">12pt</xsl:attribute><xsl:attribute
      name="padding-bottom"
    >12pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="py-4"><xsl:attribute name="padding-top">18pt</xsl:attribute><xsl:attribute
      name="padding-bottom"
    >18pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="py-5"><xsl:attribute name="padding-top">36pt</xsl:attribute><xsl:attribute
      name="padding-bottom"
    >36pt</xsl:attribute></xsl:attribute-set>
  ...
  <xsl:attribute-set name="mx-0"><xsl:attribute name="margin-left">0</xsl:attribute><xsl:attribute
      name="margin-right"
    >0</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="mx-1"><xsl:attribute name="margin-left">3pt</xsl:attribute><xsl:attribute
      name="margin-right"
    >3pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="mx-2"><xsl:attribute name="margin-left">6pt</xsl:attribute><xsl:attribute
      name="margin-right"
    >6pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="mx-3"><xsl:attribute name="margin-left">12pt</xsl:attribute><xsl:attribute
      name="margin-right"
    >12pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="mx-4"><xsl:attribute name="margin-left">18pt</xsl:attribute><xsl:attribute
      name="margin-right"
    >18pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="mx-5"><xsl:attribute name="margin-left">36pt</xsl:attribute><xsl:attribute
      name="margin-right"
    >36pt</xsl:attribute></xsl:attribute-set>

  <xsl:attribute-set name="my-0"><xsl:attribute name="margin-top">0</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >0</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="my-1"><xsl:attribute name="margin-top">3pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >3pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="my-2"><xsl:attribute name="margin-top">6pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >6pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="my-3"><xsl:attribute name="margin-top">12pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >12pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="my-4"><xsl:attribute name="margin-top">18pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >18pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="my-5"><xsl:attribute name="margin-top">36pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >36pt</xsl:attribute></xsl:attribute-set>
  ...
  <!-- Border Colors -->
  <xsl:attribute-set name="border-primary"><xsl:attribute
      name="border-color"
    >#0d6efd</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-secondary"><xsl:attribute
      name="border-color"
    >#6c757d</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-success"><xsl:attribute
      name="border-color"
    >#198754</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-danger"><xsl:attribute name="border-color">#dc3545</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-warning"><xsl:attribute
      name="border-color"
    >#ffc107</xsl:attribute></xsl:attribute-set>
  ...
  <xsl:attribute-set name="border-primary-subtle"><xsl:attribute
      name="border-color"
    >#e0f2ff</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-secondary-subtle"><xsl:attribute
      name="border-color"
    >#e2e3e5</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-success-subtle"><xsl:attribute
      name="border-color"
    >#d1e7dd</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-danger-subtle"><xsl:attribute
      name="border-color"
    >#f8d7da</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-warning-subtle"><xsl:attribute
      name="border-color"
    >#fff3cd</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-info-subtle"><xsl:attribute
      name="border-color"
    >#cff4fc</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-light-subtle"><xsl:attribute
      name="border-color"
    >#fefefe</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="border-dark-subtle"><xsl:attribute
      name="border-color"
    >#ced4da</xsl:attribute></xsl:attribute-set>
  ...
  <xsl:attribute-set name="rounded-circle"><xsl:attribute
      name="fox:border-radius"
    >50%</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="rounded-pill"><xsl:attribute
      name="fox:border-radius"
    >100pt</xsl:attribute></xsl:attribute-set>

  <!-- Heading utilities (h1-h6 aliases) -->
  <xsl:attribute-set name="h1"><xsl:attribute name="font-size">28pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >bold</xsl:attribute><xsl:attribute name="margin-top">12pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >6pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="h2"><xsl:attribute name="font-size">24pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >bold</xsl:attribute><xsl:attribute name="margin-top">10pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >5pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="h3"><xsl:attribute name="font-size">18pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >bold</xsl:attribute><xsl:attribute name="margin-top">10pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >5pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="h4"><xsl:attribute name="font-size">14pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >bold</xsl:attribute><xsl:attribute name="margin-top">8pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >4pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="h5"><xsl:attribute name="font-size">12pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >bold</xsl:attribute><xsl:attribute name="margin-top">8pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >4pt</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="h6"><xsl:attribute name="font-size">10pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >bold</xsl:attribute><xsl:attribute name="margin-top">6pt</xsl:attribute><xsl:attribute
      name="margin-bottom"
    >3pt</xsl:attribute></xsl:attribute-set>

  <!-- Display utilities (display-1 to display-6) -->
  <xsl:attribute-set name="display-1"><xsl:attribute name="font-size">60pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >300</xsl:attribute><xsl:attribute name="line-height">1.2</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="display-2"><xsl:attribute name="font-size">52pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >300</xsl:attribute><xsl:attribute name="line-height">1.2</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="display-3"><xsl:attribute name="font-size">44pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >300</xsl:attribute><xsl:attribute name="line-height">1.2</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="display-4"><xsl:attribute name="font-size">36pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >300</xsl:attribute><xsl:attribute name="line-height">1.2</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="display-5"><xsl:attribute name="font-size">28pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >300</xsl:attribute><xsl:attribute name="line-height">1.2</xsl:attribute></xsl:attribute-set>
  <xsl:attribute-set name="display-6"><xsl:attribute name="font-size">24pt</xsl:attribute><xsl:attribute
      name="font-weight"
    >300</xsl:attribute><xsl:attribute name="line-height">1.2</xsl:attribute></xsl:attribute-set>
